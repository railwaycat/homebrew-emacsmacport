cask 'emacs-mac-spacemacs-icon' do
  ...
  if Hardware::CPU.intel?
    ...
    url 'https://github.com/railwaycat/homebrew-emacsmacport/releases/download/emacs-29.4-mac-10.1/emacs-29.4-mac-10.1-x86_64-13.7.6-spacemacs-icon.zip'
  else # Apple Silicon
    depends_on macos: :ventura
    ...
    if MacOS.version >= :sequoia # macOS 15
      ...
      url 'https://github.com/railwaycat/homebrew-emacsmacport/releases/download/emacs-29.4-mac-10.1/emacs-29.4-mac-10.1-arm64-15.5-spacemacs-icon.zip'
    else
      # for macOS older than 15, which is 14
      sha256 '809e5993a22a424a9293e3da33cb182ffd6b8f375c75a400cb7b95da05a1bb19'
      url 'https://github.com/railwaycat/homebrew-emacsmacport/releases/download/emacs-29.4-mac-10.1/emacs-29.4-mac-10.1-arm64-14.7.6-spacemacs-icon.zip'
    end
  end
