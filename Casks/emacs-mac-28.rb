cask 'emacs-mac-28' do
  ...
  if Hardware::CPU.intel?
    ...
    url 'https://github.com/railwaycat/homebrew-emacsmacport/releases/download/emacs-28.3-rc1-mac-9.2/emacs-28.3-rc1-mac-9.2-x86_64-13.7.6.zip'
  else # Apple Silicon
    ...
    if MacOS.version >= :sequoia # macOS 15
      ...
      url 'https://github.com/railwaycat/homebrew-emacsmacport/releases/download/emacs-28.3-rc1-mac-9.2/emacs-28.3-rc1-mac-9.2-arm64-15.5.zip'
    else
      # for macOS older than 15, which is 14
      sha256 '033c4d13ff16b408f8fa49cd021804eda1aa3db6e13d3f35ef67b9f63f425269'
      url 'https://github.com/railwaycat/homebrew-emacsmacport/releases/download/emacs-28.3-rc1-mac-9.2/emacs-28.3-rc1-mac-9.2-arm64-14.7.6.zip'
    end
  end
